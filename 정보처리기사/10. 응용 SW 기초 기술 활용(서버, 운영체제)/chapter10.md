...
| 세마포어                 | 운영체제 또는 프로그램 작성 내에서 지원하는 상호배제 알고리즘. 세마포어 변수 및 두 개의 연산으로 임계영역에 접근하는 잠금 장치에 대한 이론적 기반 |
...
| 소프트웨어 ap     | H/W에서 두 워드간의 내용을 교환할 수 명령어 제공ㄹ           |



##### 세마포어

- 운영체제 또는 프로그램 작성 내에서 지원하는 상호배제 알고리즘
...
| ------------------------------ | ------------------------------------------------------------ |
| SSTF(Shortest Seek Time First) | 현재 헤드 위치에서 가장 가까운 트랙의 요철 처리              |
